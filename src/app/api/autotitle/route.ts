...
export async function POST(req: Request) {
  ...
  // Per-user flood backstop: this calls the model but isn't metered against the
  // token budget, so cap how fast it can be looped.
  if (rateLimited(`autotitle:${user.id}`, 30, 60_000)) {
